package com.guoguo.fengyulou.computer.controller;
...
import com.guoguo.fengyulou.computer.service.ComputerService;
...
public class ComputerController {
    ...
    public String list(HttpServletRequest request, HttpSession session, Computer computer) {
        ...
        return "page/computer/computer-list";
    }
    ...
    public String ajaxList(HttpServletRequest request, HttpSession session, Computer computer) {
        ...
        request.setAttribute("pageInfo", computerService.getComputerListPage(computer));
        request.setAttribute("data", computer);
        return "page/computer/computer-list-ajax";
    }
