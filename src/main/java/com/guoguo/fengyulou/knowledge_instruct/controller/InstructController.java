package com.guoguo.fengyulou.knowledge_instruct.controller;
...
import com.guoguo.fengyulou.knowledge.service.KnowledgeService;
import com.guoguo.fengyulou.knowledge_instruct.service.InstructService;
...
public class InstructController {
    ...
    public String list(HttpServletRequest request, Instruct instruct) {
        ...
        return "page/knowledge_instruct/knowledge-instruct-list";
    }
    ...
    public String ajaxList(HttpServletRequest request, Instruct instruct) {
        ...
        instruct.setUserId(currentUserManager.getUserId());
        request.setAttribute("pageInfo", instructService.getInstructListPage(instruct));
        return "page/knowledge_instruct/knowledge-instruct-list-ajax";
    }
    ...
    public String insert(HttpServletRequest request) {
        ...
        return "page/knowledge_instruct/knowledge-instruct-save";
    }
